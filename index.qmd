...
n_auth <- ppg2_authors |> pull(name) |> n_distinct()

n_country <- ppg2_authors |> pull(country) |> n_distinct()
...
- 提案の条件
  - PPG I に対する変更であること
  - 国際藻類・菌類・植物命名規約（ICN）に基づき有効に公表されていること
:::
...
::: {.column width="50%"}
- 2023年5月以降、提案74件を受けて、議論し、投票を行った（目標：約80分類群）

- Taxon に 2026年3月 投稿済み
:::
